...
describe Accounting::LedgerEntry do
  describe ".create_entry" do
    ...
    subject { Accounting::LedgerEntry.new amount, options }

    before do
      Accounting::Transaction.stub(:create!)
    end
    ...
    context "account owners given instead of accounts" do
      ...
      it "finds accounts" do
        ...
        Accounting::LedgerEntry.new(amount, from: debit_owner, to: credit_owner,
                                       type: 123).create!
      end
    end
    ...
    context "given 0 amount" do
      ...
      it "raises InvalidAmountError" do
        lambda do
          subject.create!
        end.should raise_error(Accounting::InvalidAmountError)
      end
    end
